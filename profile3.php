            ...
            ?>
                    <!--Education Tabs-->
                     <div class="tab-pane fade show" id="v-pills-education" role="tabpanel" aria-labelledby="v-pills-education-tab">
                        ...
                        <a   data-toggle="modal" data-target="#educationModal" data-whatever="@education" class="edu-edit" id="edit"
                        ...
                        <form id="edit-form"  action="updateEdu.php" method="post" >
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <label >Start:</label>
                                <select class="form-select" name="startyear" id="yearEd">
                            ...
                            <div class="col-md-6">
                                ...
                                <label >End:</label>
                                <select class="form-select" name="endyear" id="endyearEd">
...
$('#degree').val(degree)
$('#yearEd').val(yearStart)
$('#endyearEd').val(yearEnd)
